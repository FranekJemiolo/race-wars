...
- Name: auth.spec.ts >> Authentication >> should show validation errors for empty fields
...
Locator: locator('[data-testid="email-error"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="email-error"]')
...
- generic [ref=e4]:
  ...
  - generic [ref=e8]:
    - generic [ref=e9]:
      ...
      - textbox "Enter your username" [active] [ref=e11]
    - generic [ref=e12]:
