...
- Name: system-integration.spec.ts >> System Integration Tests >> Error Handling >> should handle form validation errors
- Location: tests/e2e/system-integration.spec.ts:299:9
...
Call log:
  - waiting for locator('button:has-text("Create Race")')
