...
- Name: system-integration.spec.ts >> System Integration Tests >> Authentication Flow >> should complete full authentication cycle
- Location: tests/e2e/system-integration.spec.ts:5:9
