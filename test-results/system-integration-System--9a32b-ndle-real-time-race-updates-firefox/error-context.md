...
- Name: system-integration.spec.ts >> System Integration Tests >> Real-time Features >> should handle real-time race updates
- Location: tests/e2e/system-integration.spec.ts:257:9
