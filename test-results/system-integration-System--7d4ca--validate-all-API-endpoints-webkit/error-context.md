...
- Name: system-integration.spec.ts >> System Integration Tests >> API Endpoints >> should validate all API endpoints
- Location: tests/e2e/system-integration.spec.ts:274:9
