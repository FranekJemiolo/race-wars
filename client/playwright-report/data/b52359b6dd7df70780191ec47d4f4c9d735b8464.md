...
- Name: rendering.spec.ts >> Client Rendering >> should display connection indicator
- Location: e2e/rendering.spec.ts:31:7
...
Locator: locator('text=Disconnected')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Disconnected')
